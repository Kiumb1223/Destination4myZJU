    ...
    \begin{tabularx}{.8\textwidth}{X<{\centering}}
        ...
        }
        {
            ...
            }
            {
                ...
                % {Cross-Domain Adaptive}{Multi-Object Tracking}{Using Graph Neural Networks}
                \uline{\hfill Cross-Domain Adaptive Multi-Object Tracking  \hfill} \\
                \uline{\hfill Using Graph Neural Networks \hfill} \\
            }
        }
    \end{tabularx}
\end{center}
